...
const SideBar = () => {
  ...
  const styleActive = isActive ? `side-bar__nav-li side-bar__nav-li--active` : `side-bar__nav-li`;
  ...
  return (
    ...
    <ul className="side-bar__nav">
      <li className={`side-bar__nav-li ${isActive ? `side-bar__nav-li--active` : ``} `} onClick={handleClick}>
        <Link to="/">
