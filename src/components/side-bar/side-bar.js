...
const SideBar = () => {
  ...
  return (
    ...
    <nav className="side-bar__nav">
      ...
      <NavLink to="/" className={({isActive}) => isActive ? `side-bar__nav-li side-bar__nav-li--active` : `side-bar__nav-li` }>
      ...
      <NavLink to="/search" className={({isActive}) => isActive ? `side-bar__nav-li side-bar__nav-li--active` : `side-bar__nav-li` }>
